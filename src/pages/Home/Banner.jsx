        ...
        <div className="block md:flex md:space-x-2 px-2 lg:p-0">
            ...
            >
                ...
                <div className="p-4 absolute bottom-0 left-0 z-20">
                    ...
                    <h2 className="text-4xl font-semibold text-gray-100 leading-tight">
                        Food is any substance consumed to provide  support and energy to an organism.
                    </h2>
            ...
            >
                ...
                <div className="p-4 absolute bottom-0 left-0 z-20">
                    ...
                    <h2 className="text-3xl font-semibold text-gray-100 leading-tight">Food science is   problems around the production of food.
                        .</h2>
                    <div className="flex mt-3">
                        <img src="https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg" className="h-10 w-10 rounded-full mr-2 object-cover" alt="Author" />
                        <div>
